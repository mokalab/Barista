...
/**
 * Clearable EditText with the ability to work with custom fonts.
 *
 * <br><br>
 * Author: David Fernandez
 */
public class TfClearableEditText extends ClearableEditText implements ITypeFaceStyleable {

    /**
     * Constructs ClearableEditText with custom Type Face.
     */
    public TfClearableEditText(Context context) {
        this(context, null, 0);
    }
     ...
     * Constructs ClearableEditText with custom Type Face.
     */
    public TfClearableEditText(Context context, AttributeSet attrs) {
     ...
     * Constructs ClearableEditText with custom Type Face.
     */
    public TfClearableEditText(final Context context, final AttributeSet attrs, final int defStyle) {
