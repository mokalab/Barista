...
/**
 * Checkable TextView with the ability to work with custom fonts.
 *
 * <br><br>
 * Author: David Fernandez
 */
public class TfCheckedTextView extends CheckedTextView implements ITypeFaceStyleable {

    /**
     * Constructs CheckedTextView with custom Type Face.
     */
    public TfCheckedTextView(Context context) {
        this(context, null, 0);
    }
     ...
     * Constructs CheckedTextView with custom Type Face.
     */
    public TfCheckedTextView(Context context, AttributeSet attrs) {
     ...
     * Constructs CheckedTextView with custom Type Face.
     */
    public TfCheckedTextView(final Context context, final AttributeSet attrs, final int defStyle) {
