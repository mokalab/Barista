 ...
 */
public class TfButton extends Button implements ITypeFaceStyleable {

    /**
     * Constructs Button with custom Type Face.
     */
     ...
     * Constructs Button with custom Type Face.
     */
    public TfButton(final Context context, final AttributeSet attrs, final int defStyle) {
