...
/**
 * RadioButton with the ability to work with custom fonts.
 *
 * <br><br>
 * Author: David Fernandez
 */
public class TfRadioButton extends RadioButton implements ITypeFaceStyleable {

    /**
     * Constructs RadioButton with custom Type Face.
     */
    public TfRadioButton(Context context) {
        this(context, null, 0);
    }
     ...
     * Constructs RadioButton with custom Type Face.
     */
    public TfRadioButton(Context context, AttributeSet attrs) {
     ...
     * Constructs RadioButton with custom Type Face.
     */
    public TfRadioButton(final Context context, final AttributeSet attrs, final int defStyle) {
