 ...
 * Author: Pirdad S.
 */
public class TfEditText extends EditText implements ITypeFaceStyleable {

    /**
     * Constructs EditText with custom Type Face.
     */
     ...
     * Constructs EditText with custom Type Face.
     */
    public TfEditText(final Context context, final AttributeSet attrs, final int defStyle) {
